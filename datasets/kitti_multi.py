...
id_to_trainid = multitask_labels.label2trainid
num_classes = 21 #19
ignore_label = 255
...
def get_train_val(cv_split, all_items):
    ...
    val_0 = []
    val_1 = []
    val_2 = [3,6,13,21,41,54,61,73,88,91,110,121,126,131,142,149,150,163,173,183,199,200,201,202,203,204,205,206,207,208,209,210,211,212,213,214]
